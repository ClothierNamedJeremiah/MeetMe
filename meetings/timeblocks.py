...
## I encountered an error when trying to store busy_times as a session variable
## Something along the lines of TypeError: ObjectId('') is not JSON serializable
## Source: https://stackoverflow.com/a/23088785/4967874
class MyEnconder(json.JSONEncoder):
	def default(self,obj):
		if isinstance(obj,TimeBlock):
			return {"start_time": obj.start_time.isoformat(),
